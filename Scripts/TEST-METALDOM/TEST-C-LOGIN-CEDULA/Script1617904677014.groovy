...
WebUI.setText(findTestObject('METALDOM_LOGIN/Page_Sign in/input_Username or email address_Username or email address'), GlobalVariable.USER_CEDULA)

WebUI.focus(findTestObject('METALDOM_LOGIN/Page_Sign in/input_Olvid su contrasea_Contrasea'))

WebUI.setText(findTestObject('METALDOM_LOGIN/Page_Sign in/input_Olvid su contrasea_Contrasea'), GlobalVariable.PASS_CEDULA)
